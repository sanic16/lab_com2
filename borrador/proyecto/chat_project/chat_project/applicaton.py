...
class Application(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.text = tk.Text(self, width=80, height=15, bg="sky blue", fg="black")
    ...
    def send(self, event):
        data = self.var.get()
        data2 = "[" + str(datetime.datetime.now()) + "-" + "Julio] " + data + "\n"
    ...
    def serialEvent(self):
        ...
        while self.read is True:
            ...
            self.datos = "[" + str(datetime.datetime.now()) + "-" + "Mike] " + self.datos + "\n"
